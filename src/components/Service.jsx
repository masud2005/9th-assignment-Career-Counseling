...
const Service = ({ service }) => {
  const { id, image, serviceName, category, price, counselor, buttonText } = service;
  ...
  return (
      <div className="card bg-white shadow-xl rounded-lg overflow-hidden transform transition duration-500 hover:-translate-y-2 hover:shadow-2xl">
        <div className="relative">
          ...
          />
          <div className="absolute top-3 right-3 bg-emerald-500 text-white text-sm px-3 py-1 rounded-full shadow-md font-semibold">{price}</div>
        </div>
        <div className="p-6">
